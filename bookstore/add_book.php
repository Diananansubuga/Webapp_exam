...
if (isset($_POST['submit'])) {
    ...
    // Check if quantity and book_img are set in $_POST
    $quantity = isset($_POST['quantity']) ? sanitize($connect, $_POST['quantity']) : null;
    $book_img = isset($_POST['book_img']) ? sanitize($connect, $_POST['book_img']) : null;
    ...
    if (mysqli_num_rows($check_result) > 0) {
        ...
        $insert_query = "INSERT INTO books (title, author, genre, date_pub, price, quantity, book_img) VALUES ('$title', '$author', '$genre', '$date_pub', '$price', '$quantity', '$book_img')";
    ...
    <div class="container">
        ...
        <form action="add_book.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" id="Quantity" name="price" step="0.01" required>
            </div>
            <div class="form-group">
                <label for="price">Book Image Source</label>
                <input type="number" id="img" name="price" step="0.01" required>
            </div>
